...
my_button = Button(countdown_window, text="Push", font = ('Arial', 24), command=decrement)
my_button.pack(padx=margin,pady=margin)

# 3. Define the Label widget and pack it into the main
#    window
my_label = Label(countdown_window, text="10", font = ('Arial', 24))
my_label.pack(padx=margin,pady=margin)
